-- https://bitbucket.org/akaposi/ttt/src/master/2022aut/t1/gy04.agda
...
dist = (λ x → case (snd x) (λ b → inl (fst x , b)) λ c → inr (fst x , c)) , {!!}
{-
bemegyek a lyukba, C-c C-,
beirok valamit C-c C-.
ha jo, akkor C-c C-space
kezdem elolrol
...
GOAL    ? , ?       inl ?          tt                  λ x → ?
                    inr ?
        -----------------------------------------------------
ASS w   fst w       case w ? ?           exfalso w     w ?
        snd w       
-}
