...
de nem lehetetlen. Ez például bizonyítja a kvízben előforduló állításról,
hogy nem egyenlőek.
Nem kell még érteni, hogy mi van ideírva, csak annyi a lényeg, hogy
be lehet bizonyítani azon állításokat, amelyek a kvízben vannak és lesznek.
-}
