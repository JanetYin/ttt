...
insertAt-test1 : insertAt {ℕ} zero 0 (1 ∷ 2 ∷ []) ≡ 0 ∷ 1 ∷ 2 ∷ []
insertAt-test1 = refl

insertAt-test2 : insertAt {ℕ} (suc zero) 0 (1 ∷ 2 ∷ []) ≡ 1 ∷ 0 ∷ 2 ∷ []
insertAt-test2 = refl

insertAt-test3 : insertAt {ℕ} (suc (suc zero)) 0 (1 ∷ 2 ∷ []) ≡ 1 ∷ 2 ∷ 0 ∷ []
insertAt-test3 = refl

insertAt-test4 : insertAt zero true (false ∷ false ∷ false ∷ []) ≡ true ∷ false ∷ false ∷ false ∷ []
insertAt-test4 = refl

insertAt-test5 : insertAt (suc zero) true (false ∷ false ∷ false ∷ []) ≡ false ∷ true ∷ false ∷ false ∷ []
insertAt-test5 = refl

insertAt-test6 : insertAt (suc (suc zero)) true (false ∷ false ∷ false ∷ []) ≡ false ∷ false ∷ true ∷ false ∷ []
insertAt-test6 = refl

insertAt-test7 : insertAt (suc (suc (suc zero))) true (false ∷ false ∷ false ∷ []) ≡ false ∷ false ∷ false ∷ true ∷ []
insertAt-test7 = refl
{-
...
removeAt-test1 : removeAt {ℕ} zero (1 ∷ 2 ∷ 3 ∷ 4 ∷ []) ≡ 2 ∷ 3 ∷ 4 ∷ []
removeAt-test1 = refl

removeAt-test2 : removeAt {ℕ} (suc zero) (1 ∷ 2 ∷ 3 ∷ 4 ∷ []) ≡ 1 ∷ 3 ∷ 4 ∷ []
removeAt-test2 = refl

removeAt-test3 : removeAt {ℕ} (suc (suc zero)) (1 ∷ 2 ∷ 3 ∷ 4 ∷ []) ≡ 1 ∷ 2 ∷ 4 ∷ []
removeAt-test3 = refl

removeAt-test4 : removeAt {ℕ} (suc (suc (suc zero))) (1 ∷ 2 ∷ 3 ∷ 4 ∷ []) ≡ 1 ∷ 2 ∷ 3 ∷ []
removeAt-test4 = refl
...
updateValue-test1 : _[_]≔_ {ℕ} (1 ∷ 2 ∷ 9 ∷ []) zero 0 ≡ 0 ∷ 2 ∷ 9 ∷ []
updateValue-test1 = refl

updateValue-test2 : _[_]≔_ {ℕ} (1 ∷ 2 ∷ 9 ∷ []) (suc zero) 0 ≡ 1 ∷ 0 ∷ 9 ∷ []
updateValue-test2 = refl

updateValue-test3 : _[_]≔_ {ℕ} (1 ∷ 2 ∷ 9 ∷ []) (suc (suc zero)) 0 ≡ 1 ∷ 2 ∷ 0 ∷ []
