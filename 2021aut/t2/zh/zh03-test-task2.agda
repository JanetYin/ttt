module 2021aut.t2.zh.zh03-test-task2 where
...
TestCase : 𝟚 → 𝟚 → 𝟚 → Set
TestCase x y result = message —⠀testing⠀for 𝟚 values: zh.task2 x y ≡ result
  where
    message : String
    message = "Testing for " +++ 𝟚to𝕊 x +++ " XOR " +++ 𝟚to𝕊 y +++ " (= " +++ 𝟚to𝕊 result +++ ")"
