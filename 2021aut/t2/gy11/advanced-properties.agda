module 2021aut.t2.gy11.advanced-properties where
open import lib
...
suc*' suc* : (a b : ℕ) → Eqℕ (a + a * b) (a * suc b)
{-
e : n + n * b = n * suc b

  suc n + suc n * b   = suc n * suc b
    (triv)
  n + (b + n * b)     =
    (ass)
  (n + b) + n * b     =
...
suc*' = λ a b → indℕ
  ...
  triv
  (λ n e → trans (suc n + suc n * b) (n + b + n * b) (suc n * suc b)
    (sym (n + b + n * b) (suc n + suc n * b) {!ass n b (n * b)!})
    {!!})
  a
suc* = λ a b → indℕ
  (λ a → Eqℕ (a + a * b) (a * suc b))
